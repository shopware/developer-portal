...
sh ./.github/scripts/clone.sh gitlab+deploy-token-214:${GITLAB_FRONTENDS_ACCESS_KEY}@gitlab.shopware.com/product/engineering/platform-group/pwa/frontends.git DX-202 apps/docs/src frontends-gl
...
echo "\nBuilding icons"
#temp
ICON_KIT_ORG=bojanrajh
sh ./.github/scripts/clone.sh git@github.com/${ICON_KIT_ORG}/meteor-icon-kit.git main docs resources/meteor-icon-kit meteor-icon-kit
