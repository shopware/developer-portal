...
sh ./.github/scripts/clone.sh ${GITLAB_FRONTENDS_ACCESS_KEY}:${GITLAB_FRONTENDS_ACCESS_KEY}@gitlab.shopware.com/product/engineering/platform-group/pwa/frontends.git ${BRANCH_FRONTENDS} apps/docs/src frontends-gl
sh ./.github/scripts/clone.sh git@github.com/shopware/admin-extension-sdk.git ${BRANCH_ADMIN_EXTENSION_SDK} docs/docs/guide docs/resources/admin-extension-sdk
...
echo "\nBuilding icons"
sh ./.github/scripts/clone.sh git@github.com/${ORG_METEOR_ICON_KIT}/meteor-icon-kit.git ${BRANCH_METEOR_ICON_KIT} docs resources/meteor-icon-kit meteor-icon-kit
