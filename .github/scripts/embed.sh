...
sh ./.github/scripts/clone.sh git@github.com/shopware/frontends.git main apps/docs/src docs/frontends
...
sh ./.github/scripts/clone.sh git@github.com/shopware/meteor-icon-kit.git main docs docs/resources/meteor-icon-kit
