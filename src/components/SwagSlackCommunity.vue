...
.SwagSlackCommunity {
  ...
  .container {
    ...
    padding-left: 2rem;
    padding-right: 2rem;
    background: radial-gradient(circle at center, var(--vp-c-bg) 16.666%, rgba(0, 0, 0, 0) 100%), url('/components/community.png') center center no-repeat;
  }

  &_inner-container {
    @apply flex flex-col items-center gap-4 py-12 max-w[740px];
  }
