<SwagLanding>
    ...
    <template #exposed2>
        <SwagLandingCardList>
            ...
            <template #cards>
                <SwagLandingCard link="/docs/guides/plugins/apps/app-scripts/data-loading" icon="storefront" icon-type="solid">
                    <template #title>Store details</template>
                    <template #sub>Enrich store - Populate store's detail page as required</template>
                </SwagLandingCard>
                <SwagLandingCard link="/docs/guides/plugins/apps/app-scripts/data-loading#search-criteria" icon="search" icon-type="solid">
                    <template #title>Search</template>
                    <template #sub>Find what you need - Customizable search criteria for easy search</template>
                </SwagLandingCard>
                <SwagLandingCard link="/docs/guides/plugins/apps/app-scripts/cart-manipulation" icon="balance-scale" icon-type="solid">
                    <template #title>Stock availability</template>
                    <template #sub>Never miss a sale - Real-time stock availability feature.</template>
                </SwagLandingCard>
                <SwagLandingCard link="/docs/guides/plugins/apps/app-scripts/cart-manipulation" icon="bulk-edit" icon-type="solid">
                ...
                <SwagLandingCard link="/docs/guides/plugins/apps/app-scripts/custom-endpoints#caching" icon="cog" icon-type="solid">
